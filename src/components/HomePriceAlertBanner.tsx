    ...
    <div className="rounded-xl bg-gradient-to-br from-violet-950/60 to-zinc-900 border border-violet-800/40 p-5 mb-8">
      ...
      <div data-alert-trust-note className="mb-4 rounded-lg border border-zinc-800 bg-zinc-950/60 px-3 py-2">
        ...
        <p className="mt-1 text-xs leading-5 text-zinc-400">
          Email is used for this alert request; no wallet, account, private key, or exchange login is required. Alert checks use market snapshots and can lag exchange quotes.
        </p>
      </div>
      ...
      {status === 'success' ? (
        <div className="rounded-lg bg-emerald-950/60 border border-emerald-700/40 px-4 py-3">
          <p className="text-sm text-emerald-400 font-medium">
            ...
            {direction} your target, using informational market-snapshot checks.
          </p>
        </div>
      ) : (
